                ...
                <table class="table table-bordered text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $prd->kaprodi ?></td>
                            <td>
                                <a href="prodi/view?id=<?=$prd->kode?>">View </a>|
                                <a href="prodi/edit?id=<?=$prd->kode?>">Edit </a>|
                                <a href="prodi/delete?id=<?=$prd->kode?>"
                                onclick="if(!confirm('Anda Yakin Akan Menghapus Data Prodi dengan kode : <?=$prd->kode?>?')){return false}">Delete</a>
                            </td>
                        </tr>
